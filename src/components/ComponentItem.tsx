...
export default class ComponentItem extends React.Component<PropsComponentItem, StateComponentItem>{
  ...
  render = () => {
    return <div className="py-4 px-3 rounded bg-gray-800">
      <ul className="pb-4 mb-4 space-y-2 border-b border-gray-700 text-gray-100">
        <li>
